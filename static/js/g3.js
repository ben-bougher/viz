...
;(function (window) {
  ...
  scatter.prototype.draw = function(primary, secondary){
    ...
    this._svg.selectAll('circle').data(this._data)
      .enter().append('circle')
      .attr('cx', function(d){
	return plot._xScale(d[primary]);})
      .attr('cy', function(d){
	return plot._yScale(d[secondary]);})
      .attr('r', 2);
  ...
  scatter.prototype.reDraw = function(primary, secondary){
